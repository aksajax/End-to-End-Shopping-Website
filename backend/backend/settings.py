...
SECRET_KEY = 'django-insecure-fzb2%nv_x7t0ty1!c12ol*x+beko-!+scoww1bjsy7vx19@ld%'
...
# React frontend se connect karne ke liye CORS settings
CORS_ALLOW_ALL_ORIGINS = True # Development ke liye sahi hai

# Custom User Model specify karna
